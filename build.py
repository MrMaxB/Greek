...
def main():
    ...
    js = "\n".join(read("js/" + f) for f in ["data-alphabet.js", "data-decks-core.js", "data-decks-extra.js", "data.js", "grammar.js", "official_a1.js", "rare.js", "exercises.js", "writing.js", "reading.js", "exams.js", "srs.js", "speech.js", "app.js", "feat-track.js", "feat-speaking.js", "feat-exams.js"])

    html = re.sub(r'<link rel="stylesheet" href="css/styles.css">',
                  lambda m: "<style>\n" + css + "\n</style>", html)
    html = re.sub(r'\s*<script src="js/data-alphabet.js"></script>.*?<script src="js/feat-exams.js"></script>',
